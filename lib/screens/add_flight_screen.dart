...
import '../widgets/form/role_selector.dart';
...
class _AddFlightScreenState extends State<AddFlightScreen> {
  ...
  // Hardcoded pilot license (same as logbook_screen.dart)
  ...
  /// Build FlightTime with auto-calculated role-based hours
  FlightTime get _calculatedFlightTime {
    ...
    return FlightTime(
      ...
      night: 0,
      ifr: 0,
      pic: _role == 'PIC' ? total : 0,
      sic: _role == 'SIC' ? total : 0,
      dual: _role == 'Dual' ? total : 0,
    );
  }
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Role & Landings Section
                    _SectionHeader(title: 'ROLE & LANDINGS'),
                    const SizedBox(height: 12),
                    GlassContainer(
                      padding: const EdgeInsets.all(20),
                      child: Column(
                    ...
                    // Remarks Section
                    _SectionHeader(title: 'REMARKS (OPTIONAL)'),
                    const SizedBox(height: 12),
                    GlassContainer(
                      padding: const EdgeInsets.all(20),
                      child: GlassTextField(
